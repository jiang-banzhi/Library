...
public class BaseViewHolder extends RecyclerView.ViewHolder implements DefaultItemTouchHelperCallback.OnStateChangedListener {
    ...
    public BaseViewHolder setText(@IdRes int viewId, Spannable values) {
        TextView textView = getView(viewId);
        if (null != values) {
            textView.setText(values);
        }
    ...
    public BaseViewHolder setText(@IdRes int viewId, Spanned values) {
        TextView textView = getView(viewId);
        if (null != values) {
            textView.setText(values);
        }
